      ...
      <div className="p-3  shadow-mb bg-white">
        ...
        {orden.tiempoentrega === 0 && (
          <div className="mb-4">
            ...
            <input
              type="number"
              className="shadow apperance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow"
              min="1"
              max="360"
              placeholder="20"
              value={tiempoentrega}
