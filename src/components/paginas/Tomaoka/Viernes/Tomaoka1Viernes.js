  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("tomaokaViernes").add(platillo);

        // Redireccionar
        navigate("/tomaokaViernes");
      } catch (error) {
        console.log(error);
      }
    },
...
<div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("tomaokaViernes")}
...
export default Tomaoka1Viernes;
