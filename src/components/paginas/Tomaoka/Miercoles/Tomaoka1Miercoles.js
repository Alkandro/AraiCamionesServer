  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("tomaokaMiercoles").add(platillo);

        // Redireccionar
        navigate("/tomaokaMiercoles");
      } catch (error) {
        console.log(error);
      }
    },
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("tomaokaMiercoles")}
...
export default Tomaoka1Miercoles;
