...
const User31 = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("user3").add(platillo);
  ...
  return (
    <>
      <h1 className="text-3xl font-light mb-4">User3 Lunes</h1>
...
<div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("user3")}
