  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("enriqueMensaje").add(platillo);

        // Redireccionar
        navigate("/enriqueMensaje");
      } catch (error) {
        console.log(error);
      }
    },
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("enriqueMensaje")}
...
export default Enrique1Mensaje;
