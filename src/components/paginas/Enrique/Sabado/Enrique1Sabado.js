  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("enriqueSabado").add(platillo);

        // Redireccionar
        navigate("/enriqueSabado");
      } catch (error) {
        console.log(error);
      }
    },
...
<div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("enriqueSabado")}
