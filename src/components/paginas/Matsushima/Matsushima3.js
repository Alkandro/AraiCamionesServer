...
//     try {
//       const docRef = firebase.db.collection("matsushima").doc(id);
//       const doc = await docRef.get();

//       if (doc.exists) {
//         await docRef.update({ existencia });
//       } else {
