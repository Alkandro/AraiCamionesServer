  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("matsushimaMiercoles").add(platillo);

        // Redireccionar
        navigate("/matsushimaMiercoles");
      } catch (error) {
        console.log(error);
      }
    },
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("matsushimaMiercoles")}
...
export default Matsushima1Miercoles;
