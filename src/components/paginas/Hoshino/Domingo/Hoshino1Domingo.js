  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("hoshinoDomingo").add(platillo);

        // Redireccionar
        navigate("/hoshinoDomingo");
      } catch (error) {
        console.log(error);
      }
    },
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("hoshinoDomingo")}
...
export default Hoshino1Domingo;
