  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("hoshinoMartes").add(platillo);

        // Redireccionar
        navigate("/hoshinoMartes");
      } catch (error) {
        console.log(error);
      }
    },
          ...
          <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("hoshinoMartes")}
