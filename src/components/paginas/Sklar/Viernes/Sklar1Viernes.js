...
const Sklar1Viernes = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("sklarViernes").add(platillo);

        // Redireccionar
        navigate("/sklarViernes");
      } catch (error) {
        console.log(error);
      }
    },
  ...
  return (
    <>
      <h1 className="text-3xl font-light mb-4">Sklar Viernes</h1>
        ...
        <div className="w-full max-w-3xl">
          <form onSubmit={formik.handleSubmit}>
            <div className="mb-4">
              ...
              >
                <option value="virnes">Viernes</option>
              </select>
            </div>
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("sklarViernes")}
