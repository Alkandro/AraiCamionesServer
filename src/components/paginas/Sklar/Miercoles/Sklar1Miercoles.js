  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("sklarMiercoles").add(platillo);

        // Redireccionar
        navigate("/sklarMiercoles");
      } catch (error) {
        console.log(error);
      }
    },
...
<div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("sklarMiercoles")}
...
export default Sklar1Miercoles;
