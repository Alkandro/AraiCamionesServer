...
const Sklar1Martes = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("sklarMartes").add(platillo);

        // Redireccionar
        navigate("/sklarMartes");
      } catch (error) {
        console.log(error);
      }
    },
  ...
  return (
    <>
      <h1 className="text-3xl font-light mb-4">Sklar Martes</h1>
...
<div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("sklarMartes")}
