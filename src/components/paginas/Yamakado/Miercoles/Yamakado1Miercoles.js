  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("yamakadoMiercoles").add(platillo);

        // Redireccionar
        navigate("/yamakadoMiercoles");
      } catch (error) {
        console.log(error);
      }
    },
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("yamakadoMiercoles")}
...
export default Yamakado1Miercoles;
