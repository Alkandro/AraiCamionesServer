  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("yamakadoDomingo").add(platillo);

        // Redireccionar
        navigate("/yamakadoDomingo");
      } catch (error) {
        console.log(error);
      }
    },
...
<div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("yamakadoDomingo")}
...
export default Yamakado1Domingo;
