  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("yamakadoSabado").add(platillo);

        // Redireccionar
        navigate("/yamakadoSabado");
      } catch (error) {
        console.log(error);
      }
    },
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("yamakadoSabado")}
...
export default Yamakado1Sabado;
