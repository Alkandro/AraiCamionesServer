  ...
  const formik = useFormik({
    ...
    onSubmit: (platillo) => {
      try {
        ...
        firebase.db.collection("yamakadoMartes").add(platillo);

        // Redireccionar
        navigate("/yamakadoMartes");
      } catch (error) {
        console.log(error);
      }
    },
...
<div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <FileUploader
                ...
                name="imagen"
                randomizeFilename
                storageRef={firebase.storage.ref("yamakadoMartes")}
...
export default Yamakado1Martes;
